# Danh sách thư viện cần thiết (Dependencies)

Để chạy dự án, bạn cần cài đặt các thư viện sau đây:

- `dlib`: Nhận diện và theo dõi khuôn mặt
- `opencv-python`: Xử lý hình ảnh từ camera
- `numpy`: Tính toán ma trận
- `pygame`: Phát âm thanh cảnh báo bằng tiếng Việt
